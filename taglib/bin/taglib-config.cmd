...
:doit
if /i "%1#" == "--libs#"    echo -LD:/Program Files (x86)/taglib/lib -llibtag
if /i "%1#" == "--cflags#"  echo -ID:/Program Files (x86)/taglib/include/taglib
if /i "%1#" == "--version#" echo 1.11.1
if /i "%1#" == "--prefix#"  echo D:/Program Files (x86)/taglib
